...
Для выполнения задания (**) в блоке *yandex_lb_target_group* использован динамический блок для создания нескольких блоков *target* (`dynamic "target" { ... }`). Итерация происходит по массиву сетевых интерфейсов виртуальных машин, созданных ранее (*wp-app*) (`for_each = yandex_compute_instance.wp-app[*].network_interface.0`). Таким образом, в target_group балансировщика попадают адреса всех виртуальных машин, созданных ранее.
